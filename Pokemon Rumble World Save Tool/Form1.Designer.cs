namespace Pokemon_Rumble_World_Save_Tool
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.NUP_BDiamonds = new System.Windows.Forms.NumericUpDown();
        	...
        	((System.ComponentModel.ISupportInitialize)(this.NUP_BDiamonds)).BeginInit();
        	...
        	// NUP_BDiamonds
        	// 
        	this.NUP_BDiamonds.Enabled = false;
        	this.NUP_BDiamonds.Location = new System.Drawing.Point(384, 82);
        	this.NUP_BDiamonds.Maximum = new decimal(new int[] {
			2147483647,
			0,
			0,
			0});
        	this.NUP_BDiamonds.Name = "NUP_BDiamonds";
        	this.NUP_BDiamonds.Size = new System.Drawing.Size(73, 20);
        	this.NUP_BDiamonds.TabIndex = 25;
        	this.NUP_BDiamonds.ValueChanged += new System.EventHandler(this.Update_Data);
        	// 
        	// NUP_P
        	// 
        	...
        	this.label15.Location = new System.Drawing.Point(308, 84);
        	this.label15.Name = "label15";
        	this.label15.Size = new System.Drawing.Size(70, 13);
        	this.label15.TabIndex = 30;
        	this.label15.Text = "B. Diamonds:";
        	// 
        	// Form1
        	// 
        	...
        	this.Controls.Add(this.NUP_BDiamonds);
        	...
        	((System.ComponentModel.ISupportInitialize)(this.NUP_BDiamonds)).EndInit();
        ...
        private System.Windows.Forms.NumericUpDown NUP_BDiamonds;
